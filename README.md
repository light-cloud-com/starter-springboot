...
<h1 align="center">Spring Boot API Boilerplate</h1>
...
- `server.port` reads `$PORT`; without it the app listens on 8080 regardless of what the platform asked for
...
3. Choose **"Spring Boot"** as the framework
